...
begin
  ...
  try
    ...
    while not Q.Eof do
    begin
      FMensagem := FMensagem + 'MOVIMENTAÇÃO: '+Q.FieldByName('TIPO_MOVIMENTACAO').AsString+'\n';
      FMensagem := FMensagem + 'NOME DA MOVIMENTAÇÃO: '+Q.FieldByName('NOME_MOVIMENTACAO').AsString+'\n';
      FMensagem := FMensagem + 'RESPONSÁVEL: '+Q.FieldByName('RESPONSAVEL').AsString+'\n';
...
begin
  ...
  try
    ...
    begin
      ...
      FMensagem := FMensagem + 'VALOR NO DÉBITO: '+FormatFloat('###,###,##0.00', Q.FieldByName('FECHA_DEB').AsFloat)+'\n';
      FMensagem := FMensagem + 'VALOR NO CRÉDITO: '+FormatFloat('###,###,##0.00', Q.FieldByName('FECHA_CRED').AsFloat)+'\n';
      ...
      FMensagem := FMensagem + 'VALOR NO DÉBITO: '+FormatFloat('###,###,##0.00', Q.FieldByName('VENDA_DEB').AsFloat)+'\n';
      FMensagem := FMensagem + 'VALOR NO CRÉDITO: '+FormatFloat('###,###,##0.00', Q.FieldByName('VENDA_CRED').AsFloat)+'\n';
      ...
      FMensagem := FMensagem + '------------------------------------------------------------'+'\n';
      FMensagem := FMensagem + '                  MOVMENTAÇÕES'+'\n';
      FMensagem := FMensagem + '------------------------------------------------------------'+'\n';
      InsereMovimentacoes(IDComercio);
      FMensagem := FMensagem + '------------------------------------------------------------'+'\n';
      FMensagem := FMensagem + '           STATUS DO CAIXA'+'\n';
      FMensagem := FMensagem + '------------------------------------------------------------'+'\n';
      FMensagem := FMensagem + 'COM OS VALORES APRESENTADOS O CAIXA APRESENTA UMA DIFERENÇA DE '+
